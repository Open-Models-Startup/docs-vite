...
head:
  ...
  - ['meta', {property: 'og:image', content: 'https://openmodels.wiki/img/og/integrating-codeflowapp-bot.png'}]
...
Whenever an issue is opened, CodeflowApp checks if a openmodels.wiki bug reproduction URL is present in the comment text.
...
1. Visit [CodeflowApp profile page](https://openmodels.wiki/install-github-app)
