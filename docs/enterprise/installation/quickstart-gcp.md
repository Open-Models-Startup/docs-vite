...
head:
  ...
  - ['meta', {property: 'og:image', content: 'https://openmodels.wiki/img/og/enterprise-installation-quickstart-on-gcp.png'}]
...
After filling out the configuration fields, click "Continue". Your OpenModels EE instance is now booted and ready for DNS configuration.
