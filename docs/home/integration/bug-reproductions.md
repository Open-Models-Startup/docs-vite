...
head:
  ...
  - ['meta', {property: 'og:image', content: 'https://qixlab.com/img/og/bug-reproductions.png'}]
      ...
      - name: need reproduction
        ...
        with:
          ...
          body: |
            ...
            using a GitHub repository or [Qi X Lab](https://vite.new).
...
💡 Read all about running projects from GitHub in the [GitHub Importer Guide](/home/integration/open-from-github).

:::info How can we improve this guide?
Haven't found an answer to your question? [Let us know!](mailto:devrel@qixlab.com)
:::
