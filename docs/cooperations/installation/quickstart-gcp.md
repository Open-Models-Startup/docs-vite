...
head:
  ...
  - ['meta', {property: 'og:image', content: 'https://qixlab.com/img/og/cooperations-installation-quickstart-on-gcp.png'}]
...
After filling out the configuration fields, click "Continue". Your Qi X Lab EE instance is now booted and ready for DNS configuration.
