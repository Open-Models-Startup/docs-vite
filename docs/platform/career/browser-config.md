...
To allow PUBLISH to run in Brave, you will need to add an exception for Qi X Lab:

1. Visit a PUBLISH-based project, for instance <https://qixlab.com/edit/nextjs>. The project’s boot sequence might stay stuck on the “Running start command” step:

![Screenshot of Brave on a PUBLISH project with the Brave Shields feature on. Loading the project’s web server is stuck on the last step.](./assets/brave-stuck-project.png)
