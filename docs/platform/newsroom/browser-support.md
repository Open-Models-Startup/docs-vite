...
Projects based on NEWSROOM can be [embedded](/home/integration/embedding) as any other Qi X Lab project. However, the [restrictions detailed above](#web-platform-requirements) hit harder when embedding a project since we no longer control the headers under which the _embedding_ content is served.
