...
<a href="https://pr.new/Open-Models-Startup/docs-vite/edit/main/docs/iecho/content-updates-with-web-publisher.md">
...
- the "..." icon which opens a popup with the **"Open in iEcho IDE"** button which redirects to [iEcho IDE](./working-in-iecho-ide) - it is helpful when you want to add images or work on a few files.
