...
<a href="https://pr.new/Qi-X-Lab/docs-home/edit/main/docs/course/content-updates-with-web-publisher.md">
...
- the "..." icon which opens a popup with the **"Open in course IDE"** button which redirects to [course IDE](./working-in-course-ide) - it is helpful when you want to add images or work on a few files.
